...
const LANGUAGES = {
    en: {
        ...
        // Footer
        copyright: `© ${new Date().getFullYear()} Armenia Tax Calculator by Khachig Gabriel. All rights reserved.`,
    ...
    hy: {
        ...
        // Footer
        copyright: `© ${new Date().getFullYear()} Հայաստանի Հարկերի Հաշվիչ Խաչիկ Գաբրիելի կողմից: Բոլոր իրավունքները պաշտպանված են:`,
    ...
    ru: {
        ...
        // Footer
        copyright: `© ${new Date().getFullYear()} Калькулятор налогов Армении от Хачик Габриэль. Все права защищены.`,
